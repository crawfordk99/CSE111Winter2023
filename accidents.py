...
def main():
    ...
    try:
        ...
        with open(filename, "rt") as text_file:   
            ...
            while (perc_reduc<0) or (perc_reduc>100):
                ...
                if (perc_reduc<0) or (perc_reduc>100):
                    print(f"Invalid entry, please enter a whole number between 0 to 100.")
                else:
                    break
            print()
        ...
        print(f"File does not exist or was entered in wrong, please reenter the file name.")
    except(PermissionError):
        print(f"Permission denied. 'unreadable.csv'. Please enter a different file.")
    except(ValueError):
        print(f"Invalid entry, please enter a whole number between 0 to 100.")
    except(csv.Error):
        print(f"CSV file is formatted incorrectly. Please check the file and make sure it is separated properly with commas.")
