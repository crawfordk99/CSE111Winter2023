...
def main():
    ...
    frm_main = Frame(root)
    frm_main.master.title("Area of the Circle")
...
def populate_main_window(frm_main):
    ...
    Return: nothing
    """
    # Create a label that displays "Radius of the circle:"
    ...
    # Create a label that displays "Cms"
    lbl_radius_units = Label(frm_main, text="Cms")

    # Create a label that displays "Area:"
    lbl_area = Label(frm_main, text="Area:")

    # Create labels that will display the results.
    lbl_area_results= Label(frm_main, width=3)
    lbl_area_units = Label(frm_main, text="Cms^2")
    ...
    lbl_area_results.grid(row=1, column=1, padx=3, pady=3)
    ...
    def calculate(event):
        ...
        try:
            ...
            lbl_area_results.config(text= f"{area: .2f}")
        except ValueError:
           
           lbl_area_results.config(text="")
