...
def print_death_age(people_dict):
    ...
    for kckey, kcvalues in people_dict.items():
        kcname= kcvalues[NAME_INDEX]
        kcbirth_year= kcvalues[BIRTH_YEAR_INDEX]
        kcdeath_year= kcvalues[DEATH_YEAR_INDEX]
        kcage= kcdeath_year-kcbirth_year
        print(f"{kcname} {kcage}")
...
def count_genders(people_dict):
    ...
    for kckey, kcvalues in people_dict.items():
        kcgender_values= kcvalues[GENDER_INDEX]
        kctotal_males += kcgender_values.count("M")
        kctotal_females += kcgender_values.count("F")
    print(f"Genders")
    print(f"Number of males: {kctotal_males}")
    print(f"Number of females: {kctotal_females}")
